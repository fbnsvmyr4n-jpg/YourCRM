    ...
    <main className="relative flex min-h-screen w-full items-center justify-center px-4 py-10">
      ...
      <section className="login-card">
        ...
        <form className="mt-8 space-y-5" action={formAction}>
          ...
          <p className="rounded-xl border border-white/10 bg-white/[0.03] px-3.5 py-2.5 text-center text-xs text-[#9aa5b8]">
            Demo account — <span className="text-[#cbd5e1]">demo@yourcrm.com</span> /{" "}
            <span className="text-[#cbd5e1]">demo1234</span>
          </p>
